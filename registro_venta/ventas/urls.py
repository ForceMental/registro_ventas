...
from ventas.views import ListaVentasView, VentaListCreateView, AprobarVentaView, CancelarVentaView
...
urlpatterns = [
    ...
    path('ventas/cancelar/<int:venta_id>/', CancelarVentaView.as_view(), name='cancelar_venta'),
